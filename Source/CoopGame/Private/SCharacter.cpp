...
ASCharacter::ASCharacter()
{
	...
	//Weapon
	WeaponAttachSocketNam = "hand_rSocket";
}
...
void ASCharacter::BeginPlay()
{
	...
	HealthComp->OnHealthChanged.AddDynamic(this, &ASCharacter::OnHealthUpdated);
	...
	if (HasAuthority())
	{
		...
		if(CurrentWeapon)
		{
			...
			CurrentWeapon->AttachToComponent(GetMesh(), FAttachmentTransformRules::SnapToTargetNotIncludingScale, WeaponAttachSocketNam);
		}	
	}
}
...
void ASCharacter::Tick(float DeltaTime)
{
	...
	//FOV = FieldOfView - Camera Zoom when  I am aiming.
	float TargetFOV = bWantsToZoom ? ZoomedFOV : DefaultFOV;
	//Interpolation to smooth the camera zoom transition.
...
void ASCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//It's just ACharacter because the Character class has th Jump functionality  
